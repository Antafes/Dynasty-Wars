<div class="sentMessages">
	<div class="subheading">{$lang.sentMessages|htmlentities}</div>
		...
		<form method="post" action="index.php?chose=messages&amp;mmode=received">
			<table>
				<tr>
					...
					<th class="sender">{$lang.recipient|htmlentities}</th>
					<td class="delete">
				...
				{foreach from=$messages item=message}
					<tr>
						...
						<td class="sender">{$message.recipient|htmlentities}</td>
						<td class="delete">
